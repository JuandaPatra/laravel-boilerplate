...
<div class="row">
    <div class="col-12 col-md-12">
        <form action="{{route('roles.update', $role->id)}}" method="POST" id="productForm">
            @csrf
            @method('PUT')
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="input_post_title" name="name" type="text" placeholder="" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $role->name) }}" />
                        @error('title')
